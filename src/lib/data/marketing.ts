...
/** Rewrite legacy WinSweeps/Spinora copy from seed migrations to Royalties branding. */
function RoyaltiesBrandTextLocal(value: string | null | undefined): string | null {
  if (value == null || value === "") return value ?? null;
  return value
    .replace(/WinSweeps/g, "Royalties")
    .replace(/winsweeps/g, "Royalties")
    .replace(/Spinora/g, "Royalties")
    .replace(/spinora/g, "Royalties");
}

function RoyaltiesBrandPost<T extends MarketingPost>(post: T): T {
  return {
    ...post,
    title: RoyaltiesBrandTextLocal(post.title) ?? post.title,
    excerpt: RoyaltiesBrandTextLocal(post.excerpt),
    cover_image_url: resolveBlogCoverUrl(post.slug, post.cover_image_url),
    seo_title: RoyaltiesBrandTextLocal(post.seo_title),
    seo_description: RoyaltiesBrandTextLocal(post.seo_description),
    tags: (post.tags ?? []).map((t) => RoyaltiesBrandTextLocal(t) ?? t),
  };
}

function RoyaltiesBrandPostFull(post: MarketingPostFull): MarketingPostFull {
  const branded = RoyaltiesBrandPost(post);
  return {
    ...branded,
    content: RoyaltiesBrandTextLocal(post.content) ?? post.content,
  };
}
...
const FALLBACK_FAQS: Pick<Faq, "question" | "answer" | "category" | "sort_order">[] = [
  { category: "general", sort_order: 1, question: "How do I create a game account and start playing?",
    answer: "Sign up for a free Royalties account, then open any game and create your in-game account in one click. Your username and password are generated instantly — no download and no waiting. Add funds to your wallet, load credits into the game, and play in minutes." },
  { category: "deposits", sort_order: 2, question: "How do deposits and wallet loading work?",
    answer: "You fund your Royalties wallet once, then load credits into any game instantly from your dashboard. Deposit by CashApp, Zelle, Bitcoin or USDT — we verify the payment and credit your wallet, usually within 2 minutes. From there, loading a game is instant." },
  { category: "deposits", sort_order: 3, question: "Do I need an existing account on Fire Kirin, Juwa or other platforms?",
    answer: "No. Royalties creates the in-game account for you instantly when you pick a game. One Royalties wallet works across all 12 games, so you never juggle separate logins or balances." },
...
>[] = [
  { slug: "first-deposit-bonus", title: "50% Welcome Bonus", badge_text: "NEW PLAYERS",
    ...
    description: "Every new Royalties player gets a 50% bonus on their first deposit, applied automatically. Deposit $100, load $150 in credits across Fire Kirin, Juwa, Orion Stars, Game Vault or any of our 12 games.",
  ...
  { slug: "weekly-leaderboard-bonus", title: "Weekly Leaderboard Bonus", badge_text: "COMPETE",
    ...
    description: "Each week, the top players on the Royalties leaderboard earn bonus game credits. Play more to climb the standings and claim your weekly reward.",
    coins_bonus: 0, xp_bonus: 0, is_featured: false },
];
...
const FALLBACK_BLOG_POSTS: MarketingPost[] = [
  ...
  { id: "p02", slug: "juwa-fish-table-game",         title: "Juwa Game — How to Play & Win at Royalties",                                  excerpt: "Juwa is one of the fastest fish table games online. Here's everything you need to know: how to get started, how to win, and how to claim your bonus.", cover_image_url: "https://images.pexels.com/photos/8817671/pexels-photo-8817671.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940", tags: ["juwa", "juwa game", "fish table"],                       published_at: new Date(Date.now() - 5 * 86400000).toISOString(), seo_title: null, seo_description: null },
  ...
  { id: "p07", slug: "how-to-deposit-cashapp-fish-table", title: "How to Deposit with CashApp for Fish Table Games — Step by Step",     excerpt: "The fastest way to fund your Royalties account is CashApp. Here's the exact process from first deposit to your game credits being loaded.", cover_image_url: "https://images.pexels.com/photos/29502369/pexels-photo-29502369.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940", tags: ["cashapp fish table", "deposit cashapp sweepstakes"],     published_at: new Date(Date.now() - 2 * 86400000).toISOString(), seo_title: null, seo_description: null },
  { id: "p08", slug: "how-to-deposit-zelle-fish-table", title: "How to Deposit with Zelle for Fish Table Games — Complete Guide",        excerpt: "Zelle is one of the most secure and instant ways to deposit at Royalties. Here's exactly how to do it.", cover_image_url: "https://images.pexels.com/photos/6406691/pexels-photo-6406691.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940", tags: ["zelle fish table", "deposit zelle sweepstakes"],         published_at: new Date(Date.now() - 2 * 86400000).toISOString(), seo_title: null, seo_description: null },
  { id: "p09", slug: "crypto-deposits-fish-table",   title: "CashApp, Zelle or Crypto — Best Deposit Method for Fish Table Games",         excerpt: "Not sure which payment method to use at Royalties? We break down CashApp, Zelle, Bitcoin and USDT so you can choose the right one.", cover_image_url: "https://images.pexels.com/photos/29502363/pexels-photo-29502363.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940", tags: ["crypto fish table", "bitcoin sweepstakes"],               published_at: new Date(Date.now() - 1 * 86400000).toISOString(), seo_title: null, seo_description: null },
  { id: "p10", slug: "50-percent-first-deposit-bonus-explained", title: "50% First Deposit Bonus at Royalties — How to Claim It",       excerpt: "Royalties gives every new player a 50% bonus on their first deposit. Here's exactly how it works, what games it applies to, and how to maximize it.", cover_image_url: "https://images.pexels.com/photos/54284/pexels-photo-54284.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940", tags: ["first deposit bonus", "50% bonus sweepstakes"],          published_at: new Date(Date.now() - 1 * 86400000).toISOString(), seo_title: null, seo_description: null },
  { id: "p11", slug: "how-to-create-fire-kirin-account-online", title: "How to Create a Fire Kirin Account Online in Under 10 Minutes", excerpt: "You don't need to download an app or visit a location. Here's the exact process to create a Fire Kirin account online at Royalties.", cover_image_url: "https://images.pexels.com/photos/4841182/pexels-photo-4841182.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940", tags: ["create fire kirin account online", "fire kirin login"],  published_at: new Date(Date.now() - 12 * 3600000).toISOString(), seo_title: null, seo_description: null },
  { id: "p12", slug: "fish-table-games-online-texas", title: "Fish Table Games Online in Texas — Play Fire Kirin, Juwa & More",          excerpt: "Texas players can access all 12 Royalties fish table and sweepstakes games online. Here's how to get started from Houston, Dallas, San Antonio or anywhere in Texas.", cover_image_url: "https://images.pexels.com/photos/29096083/pexels-photo-29096083.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940", tags: ["fish table games texas", "fire kirin texas"],             published_at: new Date(Date.now() - 8 * 3600000).toISOString(), seo_title: null, seo_description: null },
  { id: "p13", slug: "game-vault-online-guide",       title: "Game Vault Online — Complete Guide to the All-in-One Platform",              excerpt: "Game Vault is the only Royalties game that packs fish tables, slots and arcade games into one platform. Here's everything you need to know.", cover_image_url: "https://images.pexels.com/photos/17370315/pexels-photo-17370315.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940", tags: ["game vault online", "game vault sweepstakes"],           published_at: new Date(Date.now() - 4 * 3600000).toISOString(), seo_title: null, seo_description: null },
  ...
  { id: "p22", slug: "cash-machine-fish-table-guide",      title: "Cash Machine Game — Steady Paylines & Free-Spin Engine Guide",                        excerpt: "Cash Machine is the consistent earner of the Royalties catalog — reliable paylines and a generous free-spin engine that rewards patient play.", cover_image_url: "https://images.pexels.com/photos/18425165/pexels-photo-18425165.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940", tags: ["cash machine game", "cash machine fish table"],                    published_at: new Date(Date.now() - 5 * 3600000).toISOString(),  seo_title: null, seo_description: null },
  { id: "p23", slug: "fish-table-games-georgia",           title: "Fish Table Games Online in Georgia — Play Fire Kirin & Juwa From Atlanta",            excerpt: "Georgia players can access all 12 Royalties fish table games online — no download, no location required. Here's how to get started from Atlanta, Savannah or anywhere in GA.", cover_image_url: "https://images.pexels.com/photos/918802/pexels-photo-918802.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940", tags: ["fish table games georgia", "fire kirin georgia", "juwa georgia"],   published_at: new Date(Date.now() - 6 * 3600000).toISOString(),  seo_title: null, seo_description: null },
  { id: "p24", slug: "fish-table-games-california",        title: "Fish Table Games Online in California — LA, San Diego & Beyond",                      excerpt: "California players have full access to Royalties's 12-game lineup online. Learn how to get started from Los Angeles, San Diego, Sacramento or anywhere in CA.", cover_image_url: "https://images.pexels.com/photos/25798269/pexels-photo-25798269.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940", tags: ["fish table games california", "sweepstakes california"],             published_at: new Date(Date.now() - 7 * 3600000).toISOString(),  seo_title: null, seo_description: null },
  { id: "p25", slug: "fish-table-games-ohio",              title: "Fish Table Games Online in Ohio — Columbus, Cleveland & Statewide",                    excerpt: "Ohio residents can play Fire Kirin, Juwa, Orion Stars and 9 other Royalties games online from Columbus, Cleveland, Cincinnati or anywhere in the state.", cover_image_url: "https://images.pexels.com/photos/18848584/pexels-photo-18848584.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940", tags: ["fish table games ohio", "fire kirin ohio"],                          published_at: new Date(Date.now() - 8 * 3600000).toISOString(),  seo_title: null, seo_description: null },
  { id: "p26", slug: "fish-table-games-north-carolina",    title: "Fish Table Games Online in North Carolina — Charlotte, Raleigh & More",               excerpt: "North Carolina players can enjoy all 12 Royalties games online — no physical location needed. Play Fire Kirin, Juwa and more from Charlotte, Raleigh or anywhere in NC.", cover_image_url: "https://images.pexels.com/photos/4836513/pexels-photo-4836513.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940", tags: ["fish table games north carolina", "fire kirin north carolina"],     published_at: new Date(Date.now() - 9 * 3600000).toISOString(),  seo_title: null, seo_description: null },
  { id: "p27", slug: "fish-table-games-michigan",          title: "Fish Table Games Online in Michigan — Detroit, Grand Rapids & Statewide",              excerpt: "Michigan players have full access to Royalties's 12 sweepstakes games. Here's how to start playing Fire Kirin, Juwa and Orion Stars from Detroit, Grand Rapids or anywhere in MI.", cover_image_url: "https://images.pexels.com/photos/35736659/pexels-photo-35736659.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940", tags: ["fish table games michigan", "sweepstakes games michigan"],           published_at: new Date(Date.now() - 10 * 3600000).toISOString(), seo_title: null, seo_description: null },
  { id: "p28", slug: "how-to-deposit-bitcoin-fish-table",  title: "How to Deposit with Bitcoin for Fish Table Games — Instant & Secure",                 excerpt: "Bitcoin and USDT are the fastest deposit methods for Royalties. Here's the step-by-step: what wallet to use, how to send, and when your credits appear.", cover_image_url: "https://images.pexels.com/photos/29502355/pexels-photo-29502355.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940", tags: ["bitcoin fish table", "crypto deposit sweepstakes"],                 published_at: new Date(Date.now() - 11 * 3600000).toISOString(), seo_title: null, seo_description: null },
  { id: "p29", slug: "fire-kirin-tips-and-tricks",         title: "Fire Kirin Tips & Tricks — Expert Strategies to Maximize Your Winnings",              excerpt: "Fire Kirin is the most popular fish table game at Royalties for a reason. Here are the targeting, ammo and timing strategies that experienced players use to stay profitable.", cover_image_url: "https://images.pexels.com/photos/10885433/pexels-photo-10885433.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940", tags: ["fire kirin tips", "fire kirin strategy"],                           published_at: new Date(Date.now() - 12 * 3600000).toISOString(), seo_title: null, seo_description: null },
  ...
  { id: "p31", slug: "vip-program-guide-Royalties",        title: "Royalties VIP Program — How to Climb from Silver to Elite",                          excerpt: "Royalties has 5 VIP tiers: Silver, Gold, Platinum, Diamond and Elite. Each level unlocks higher reward multipliers. Here's exactly how to earn XP and climb fast.", cover_image_url: "https://images.pexels.com/photos/34972177/pexels-photo-34972177.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940", tags: ["Royalties vip", "vip fish table rewards"],                          published_at: new Date(Date.now() - 14 * 3600000).toISOString(), seo_title: null, seo_description: null },
  { id: "p32", slug: "daily-rewards-coins-guide",          title: "How to Earn Free Coins Every Day at Royalties — Daily Rewards Explained",            excerpt: "Royalties gives every player free coins daily through the daily claim, streak bonuses and achievements. Here's how to maximize every source of free rewards.", cover_image_url: "https://images.pexels.com/photos/34972181/pexels-photo-34972181.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940", tags: ["daily rewards fish table", "free coins sweepstakes"],               published_at: new Date(Date.now() - 15 * 3600000).toISOString(), seo_title: null, seo_description: null },
  { id: "p33", slug: "refer-friends-earn-coins",           title: "Earn Coins by Referring Friends at Royalties — Referral Program Guide",              excerpt: "Every friend you refer to Royalties earns you bonus coins when they qualify. Here's how the referral system works, when coins credit, and how to share your code.", cover_image_url: "https://images.pexels.com/photos/5802154/pexels-photo-5802154.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940", tags: ["referral program sweepstakes", "refer friends fish table"],        published_at: new Date(Date.now() - 16 * 3600000).toISOString(), seo_title: null, seo_description: null },
  { id: "p34", slug: "sweepstakes-games-us-nationwide",    title: "Sweepstakes Fish Table Games Available Nationwide — All 50 States",                   excerpt: "Royalties operates under the sweepstakes model, which means players across all 50 US states can participate. Here's what that means for you and how to get started.", cover_image_url: "https://images.pexels.com/photos/18425164/pexels-photo-18425164.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940", tags: ["sweepstakes games nationwide", "fish table games usa"],             published_at: new Date(Date.now() - 17 * 3600000).toISOString(), seo_title: null, seo_description: null },
  ...
  { id: "p39", slug: "how-to-create-juwa-account-online",  title: "How to Create a Juwa Account Online — Fast Setup via Royalties",                    excerpt: "You don't need to visit a store or download an unlisted app. Here's exactly how to create a Juwa account online at Royalties — instant — create your account and load credits in under 2 minutes.", cover_image_url: "https://images.pexels.com/photos/7584353/pexels-photo-7584353.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940", tags: ["create juwa account online", "juwa login"],                          published_at: new Date(Date.now() - 22 * 3600000).toISOString(), seo_title: null, seo_description: null },
  { id: "p40", slug: "how-to-create-orion-stars-account",  title: "How to Create an Orion Stars Account Online — Step-by-Step Guide",                   excerpt: "Creating an Orion Stars account through Royalties takes under 2 minutes. Here's the full process: submitting your request, making your deposit and receiving your login.", cover_image_url: "https://images.pexels.com/photos/4841182/pexels-photo-4841182.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940", tags: ["create orion stars account", "orion stars login online"],           published_at: new Date(Date.now() - 23 * 3600000).toISOString(), seo_title: null, seo_description: null },
  ...
  { id: "p43", slug: "maximize-fish-table-bonus",          title: "How to Maximize Your Fish Table Bonus — 7 Strategies That Actually Work",             excerpt: "Between the 50% first deposit bonus, daily rewards, VIP multipliers and reload bonuses, there are multiple ways to stretch every dollar at Royalties. Here's how.", cover_image_url: "https://images.pexels.com/photos/4690384/pexels-photo-4690384.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940", tags: ["fish table bonus strategy", "maximize sweepstakes bonus"],          published_at: new Date(Date.now() - 26 * 3600000).toISOString(), seo_title: null, seo_description: null },
  { id: "p44", slug: "vblink-game-guide",                  title: "VBlink Game Guide — Sub-Second Spins & Stacked Bonus Rounds",                        excerpt: "VBlink is the fastest slot-style game in the Royalties lineup. Here's how the sub-second spin mechanic works, how stacked bonuses trigger, and how to play it profitably.", cover_image_url: "https://images.pexels.com/photos/6236114/pexels-photo-6236114.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940", tags: ["vblink game", "vblink online guide"],                               published_at: new Date(Date.now() - 27 * 3600000).toISOString(), seo_title: null, seo_description: null },
  ...
  { id: "p46", slug: "best-fish-table-games-beginners",    title: "Best Fish Table Games for Beginners — Where to Start at Royalties",                  excerpt: "New to sweepstakes fish table gaming? Some games are far more beginner-friendly than others. Here are the 5 best starting points based on game speed, controls and bonus clarity.", cover_image_url: "https://images.pexels.com/photos/7584351/pexels-photo-7584351.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940", tags: ["fish table games beginners", "easy sweepstakes games"],             published_at: new Date(Date.now() - 29 * 3600000).toISOString(), seo_title: null, seo_description: null },
  { id: "p47", slug: "fish-table-games-atlanta-georgia",   title: "Fish Table Games in Atlanta, GA — Play Online From Home",                            excerpt: "Atlanta players no longer need to find a physical fish table location. Royalties gives you 12 games online, accessible from any phone or computer in the Atlanta metro area.", cover_image_url: "https://images.pexels.com/photos/17370315/pexels-photo-17370315.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940", tags: ["fish table games atlanta", "atlanta sweepstakes gaming"],            published_at: new Date(Date.now() - 30 * 3600000).toISOString(), seo_title: null, seo_description: null },
  { id: "p48", slug: "fish-table-games-houston-texas",     title: "Fish Table Games in Houston, TX — 12 Games Available Online",                        excerpt: "Houston has one of the largest fish table gaming communities in the US. Here's how Royalties brings Fire Kirin, Juwa and 10 other games to any Houston player online.", cover_image_url: "https://images.pexels.com/photos/17255079/pexels-photo-17255079.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940", tags: ["fish table games houston", "houston sweepstakes gaming"],            published_at: new Date(Date.now() - 31 * 3600000).toISOString(), seo_title: null, seo_description: null },

  // ── Wallet / cash-out system + comparison guides (full bodies in blog-content.ts) ──
  { id: "p49", slug: "wallet-deposit-guide-Royalties",     title: "How to Add Funds to Your Royalties Wallet — Deposit Guide",                          excerpt: "Fund your Royalties wallet once by CashApp, Zelle, Bitcoin or USDT, then load any game instantly. Here's the step-by-step deposit process and how fast credits arrive.", cover_image_url: "https://images.pexels.com/photos/163069/mobile-phone-money-banknotes-us-dollars-163069.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940", tags: ["Royalties wallet", "how to deposit", "add funds"],                  published_at: new Date(Date.now() - 90 * 60000).toISOString(),  seo_title: null, seo_description: "Add funds to your Royalties wallet by CashApp, Zelle, Bitcoin or USDT and load any game instantly. Step-by-step deposit guide, credited within minutes." },
  { id: "p50", slug: "how-to-load-credits-from-wallet",    title: "How to Load Game Credits From Your Wallet — Instant & Self-Serve",                   excerpt: "Creating a game account is free and instant. Here's how to load credits from your Royalties wallet into any game in seconds — with automatic refunds if a load fails.", cover_image_url: "https://images.pexels.com/photos/3790639/pexels-photo-3790639.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940", tags: ["load credits", "Royalties wallet", "game account"],                published_at: new Date(Date.now() - 80 * 60000).toISOString(),  seo_title: null, seo_description: "Load credits from your Royalties wallet into any game instantly. Free account creation, atomic wallet debit, and automatic refunds if a load fails." },
  { id: "p51", slug: "how-cash-out-works-Royalties",       title: "How Cash-Out Works at Royalties — Redeem & Get Paid",                                excerpt: "Redeem winnings from any game to your cash-out balance, then request a payout via CashApp, Zelle or crypto. Here's exactly how Royalties cash-outs work, including redeem rules.", cover_image_url: "https://images.pexels.com/photos/1006060/pexels-photo-1006060.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940", tags: ["cash out", "redeem winnings", "Royalties payout"],                 published_at: new Date(Date.now() - 70 * 60000).toISOString(),  seo_title: null, seo_description: "Redeem winnings from any game to your cash-out balance, then get paid via CashApp, Zelle or crypto. How Royalties cash-outs and redeem rules work." },
  ...
  { id: "p64", slug: "fish-table-sweepstakes-explained",              title: "Fish Table Sweepstakes Games — The Complete Guide",                        excerpt: "What fish table sweepstakes games are, how the legal sweepstakes model works, and how to start playing any game in the Royalties lineup.", cover_image_url: "https://images.pexels.com/photos/4836513/pexels-photo-4836513.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940", tags: ["fish table sweepstakes", "sweepstakes fish table games"],        published_at: new Date(Date.now() - 46 * 10000).toISOString(), seo_title: "Fish Table Sweepstakes Games — The Complete Guide | Royalties", seo_description: "Fish table sweepstakes games explained: how the legal sweepstakes model works, the Royalties game lineup, and how to start playing in minutes." },
  { id: "p65", slug: "fish-em-up-online-alternatives",                 title: "Looking for Fish Em Up? Play These Fish Table Games at Royalties Instead", excerpt: "Fish Em Up isn't part of the Royalties catalog — here are the closest fish table games you can actually play, like Fire Kirin and Juwa.", cover_image_url: "https://images.pexels.com/photos/106152/euro-coins-currency-money-106152.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940", tags: ["fish em up", "play fish em up", "fish table games online"],       published_at: new Date(Date.now() - 44 * 10000).toISOString(), seo_title: "Fish Em Up Online — Play These Fish Table Alternatives | Royalties", seo_description: "Searching for Fish Em Up? It's not in the Royalties lineup — play Fire Kirin, Juwa, Orion Stars and more fish table games instead, free account today." },
  { id: "p66", slug: "luckytap-slots-guide-Royalties-alternative",     title: "Twin Happiness, Smashing Sevens, Survivor & Family Feud — LuckyTap Slots Guide", excerpt: "Twin Happiness, Smashing Sevens Win Ways, Survivor and Family Feud are LuckyTap slots not on Royalties — here's what to play instead.", cover_image_url: "https://images.pexels.com/photos/10885433/pexels-photo-10885433.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940", tags: ["twin happiness slot", "smashing sevens win ways", "survivor luckytap", "family feud luckytap"], published_at: new Date(Date.now() - 42 * 10000).toISOString(), seo_title: "LuckyTap Slots Guide — Twin Happiness, Smashing Sevens & More | Royalties", seo_description: "Twin Happiness, Smashing Sevens Win Ways, Survivor and Family Feud aren't on Royalties — see the closest slot games you can actually play here." },
  { id: "p67", slug: "how-sweepstakes-payouts-work",                   title: "How Sweepstakes Game Payouts Work — Volatility, Boss Fish & Jackpot Pools", excerpt: "How payouts work across fish table and slot sweepstakes games — volatility, boss encounters, and shared jackpot pools explained.", cover_image_url: "https://images.pexels.com/photos/259165/pexels-photo-259165.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940", tags: ["sweepstakes game payouts", "fish table payout", "how sweepstakes games pay"], published_at: new Date(Date.now() - 40 * 10000).toISOString(), seo_title: "How Sweepstakes Game Payouts Work | Royalties", seo_description: "How fish table and slot sweepstakes payouts actually work — volatility, boss encounters and jackpot pools explained honestly, no fake odds." },
  { id: "p68", slug: "ultrapanda-game-guide",                          title: "Ultrapanda Online — Complete Game Guide",                                   excerpt: "Ultrapanda blends fish table shooting with slot-style bonus rounds. Here's how it works and how to start playing at Royalties.", cover_image_url: "https://images.pexels.com/photos/29790831/pexels-photo-29790831.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940", tags: ["ultrapanda", "ultrapanda online", "ultrapanda game"],             published_at: new Date(Date.now() - 38 * 10000).toISOString(), seo_title: "Ultrapanda Online — Complete Game Guide | Royalties", seo_description: "Play Ultrapanda at Royalties — fish table shooting plus slot-style bonus rounds. How it works, strategy basics, and how to get started." },
  { id: "p69", slug: "gameroom-game-guide",                            title: "Gameroom Online — Slots, Fish Tables & Keno Guide",                        excerpt: "Gameroom bundles slots, fish tables and keno in one account, with a $5 minimum deposit. Here's the full breakdown.", cover_image_url: "https://images.pexels.com/photos/35736659/pexels-photo-35736659.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940", tags: ["gameroom online", "gameroom game", "gameroom sweepstakes"],       published_at: new Date(Date.now() - 36 * 10000).toISOString(), seo_title: "Gameroom Online — Slots, Fish Tables & Keno Guide | Royalties", seo_description: "Gameroom at Royalties: slots, fish tables and keno in one account, $5 minimum deposit, 50% first deposit bonus. Full game guide." },
  { id: "p70", slug: "mafia-vs-juwa",                                  title: "Mafia vs Juwa — Which Fish Table Should You Play?",                       excerpt: "Mafia's Boss battles and jackpot pools vs Juwa's fast Chain Reaction combos — full comparison to help you choose.", cover_image_url: "https://images.pexels.com/photos/18425164/pexels-photo-18425164.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940", tags: ["mafia vs juwa", "best fish table game"],                          published_at: new Date(Date.now() - 34 * 10000).toISOString(), seo_title: "Mafia vs Juwa — Which Fish Table Wins? | Royalties", seo_description: "Mafia vs Juwa compared: Boss battles and jackpot pools versus fast Chain Reaction combos. Which fish table game should you play?" },
  { id: "p71", slug: "panda-master-vs-ultrapanda",                     title: "Panda Master vs Ultrapanda — Which Panda Game Should You Play?",          excerpt: "Panda Master's Giant Panda Boss vs Ultrapanda's hybrid slot bonus rounds — full comparison.", cover_image_url: "https://images.pexels.com/photos/36484265/pexels-photo-36484265.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940", tags: ["panda master vs ultrapanda", "best fish table game"],             published_at: new Date(Date.now() - 32 * 10000).toISOString(), seo_title: "Panda Master vs Ultrapanda Compared | Royalties", seo_description: "Panda Master vs Ultrapanda: a pure fish table Boss shooter versus a hybrid slot-and-fish game. Which panda-themed game fits your style?" },
  { id: "p72", slug: "cash-machine-vs-cash-frenzy",                    title: "Cash Machine vs Cash Frenzy — Which Slot Should You Play?",               excerpt: "Cash Machine's steady paylines vs Cash Frenzy's free-spin chains — full comparison of Royalties's two consistency-focused slots.", cover_image_url: "https://images.pexels.com/photos/25798270/pexels-photo-25798270.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940", tags: ["cash machine vs cash frenzy", "best sweepstakes slot"],           published_at: new Date(Date.now() - 30 * 10000).toISOString(), seo_title: "Cash Machine vs Cash Frenzy Compared | Royalties", seo_description: "Cash Machine vs Cash Frenzy: steady low-variance paylines versus free-spin chains and a climbing cash meter. Which slot fits your style?" },
  { id: "p73", slug: "vblink-vs-milky-way",                            title: "VBlink vs Milky Way — Which Game Should You Play?",                       excerpt: "VBlink's sub-second spins vs Milky Way's Galactic Storm multiplier — full comparison.", cover_image_url: "https://images.pexels.com/photos/4841182/pexels-photo-4841182.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940", tags: ["vblink vs milky way", "best sweepstakes game"],                   published_at: new Date(Date.now() - 28 * 10000).toISOString(), seo_title: "VBlink vs Milky Way Compared | Royalties", seo_description: "VBlink vs Milky Way: sub-second stacked-bonus spins versus a space-themed fish table with a 5x Galactic Storm event. Full comparison." },
  { id: "p74", slug: "mr-all-in-one-vs-game-vault",                    title: "Mr. All In One vs Game Vault — Which All-In-One Platform Wins?",          excerpt: "Both bundle fish tables, slots and arcade games — here's how Mr. All In One and Game Vault actually compare.", cover_image_url: "https://images.pexels.com/photos/34926379/pexels-photo-34926379.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940", tags: ["mr all in one vs game vault", "best sweepstakes platform"],       published_at: new Date(Date.now() - 26 * 10000).toISOString(), seo_title: "Mr. All In One vs Game Vault Compared | Royalties", seo_description: "Mr. All In One vs Game Vault: two all-in-one sweepstakes platforms compared on library size, variety and bonuses. Which should you create first?" },
  { id: "p75", slug: "gameroom-vs-orion-stars",                        title: "Gameroom vs Orion Stars — Variety or Deep Jackpots?",                     excerpt: "Gameroom's slots-fish-keno variety vs Orion Stars' layered constellation jackpots — full comparison.", cover_image_url: "https://images.pexels.com/photos/7083955/pexels-photo-7083955.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940", tags: ["gameroom vs orion stars", "best sweepstakes game"],              published_at: new Date(Date.now() - 24 * 10000).toISOString(), seo_title: "Gameroom vs Orion Stars Compared | Royalties", seo_description: "Gameroom vs Orion Stars: a multi-format slots/fish/keno platform versus a focused fish table with deep jackpot tiers. Which fits you?" },
  { id: "p76", slug: "Royalties-xp-leveling-explained",                title: "Royalties XP & Leveling Explained — How to Climb Levels Fast",            excerpt: "The exact XP curve behind Royalties levels, where XP comes from, and how leveling connects to VIP tiers.", cover_image_url: "https://images.pexels.com/photos/7584353/pexels-photo-7584353.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940", tags: ["Royalties xp", "Royalties leveling", "how to level up fast"],    published_at: new Date(Date.now() - 22 * 10000).toISOString(), seo_title: "Royalties XP & Leveling Explained | Royalties", seo_description: "How Royalties XP and leveling actually work: the exact XP curve, every XP source, and how leveling connects to VIP tier multipliers." },
  { id: "p77", slug: "Royalties-leaderboard-guide",                    title: "Royalties Leaderboard Guide — How Rankings Are Calculated",               excerpt: "How Royalties leaderboards rank players, the daily/weekly/monthly/all-time reset schedule, and how to climb fast.", cover_image_url: "https://images.pexels.com/photos/7842994/pexels-photo-7842994.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940", tags: ["Royalties leaderboard", "leaderboard rewards"],                   published_at: new Date(Date.now() - 20 * 10000).toISOString(), seo_title: "Royalties Leaderboard Guide — How Rankings Work | Royalties", seo_description: "How Royalties leaderboard rankings are calculated, the reset schedule for daily/weekly/monthly/all-time boards, and how to climb fast." },
  { id: "p78", slug: "Royalties-payment-methods-compared",             title: "All Royalties Payment Methods Compared",                                  excerpt: "CashApp, Zelle, Chime, PayPal, Venmo, Bitcoin and USDT compared — which deposit method is fastest for you.", cover_image_url: "https://images.pexels.com/photos/5437587/pexels-photo-5437587.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940", tags: ["Royalties payment methods", "how to deposit Royalties"],         published_at: new Date(Date.now() - 18 * 10000).toISOString(), seo_title: "All Royalties Payment Methods Compared", seo_description: "CashApp, Zelle, Chime, PayPal, Venmo, Bitcoin and USDT compared for Royalties deposits — which method is fastest and best for your amount." },
  { id: "p79", slug: "Royalties-telegram-support-guide",               title: "How to Get Fast Support at Royalties via Telegram",                       excerpt: "How to reach Royalties support through Telegram, what it's best for, and how VIP tiers affect response time.", cover_image_url: "https://images.pexels.com/photos/41206/background-british-budget-business-41206.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940", tags: ["Royalties telegram support", "Royalties contact"],                published_at: new Date(Date.now() - 16 * 10000).toISOString(), seo_title: "Royalties Telegram Support Guide", seo_description: "How to contact Royalties support via Telegram for deposits, account setup and general questions, plus VIP priority response times." },
  { id: "p80", slug: "sweepstakes-vs-real-money-gambling",             title: "Sweepstakes vs Real-Money Gambling — Key Legal Differences Explained",    excerpt: "The legal difference between sweepstakes gaming and real-money gambling, and why it means Royalties is available nationwide.", cover_image_url: "https://images.pexels.com/photos/29825627/pexels-photo-29825627.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940", tags: ["sweepstakes vs gambling", "are sweepstakes games legal"],        published_at: new Date(Date.now() - 14 * 10000).toISOString(), seo_title: "Sweepstakes vs Real-Money Gambling Explained | Royalties", seo_description: "Sweepstakes games vs real-money gambling: the legal structure that makes sweepstakes gaming available nationwide, explained clearly." },
  { id: "p81", slug: "is-Royalties-legit",                             title: "Is Royalties Legit? Trust, Verification & Support Explained",             excerpt: "How Royalties verifies deposits, keeps an append-only transaction ledger, and handles support — what to check on any platform.", cover_image_url: "https://images.pexels.com/photos/7584351/pexels-photo-7584351.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940", tags: ["is Royalties legit", "Royalties trust and safety"],               published_at: new Date(Date.now() - 12 * 10000).toISOString(), seo_title: "Is Royalties Legit? Trust & Verification Explained", seo_description: "Is Royalties legit? How deposits are manually verified, transactions are recorded on an append-only ledger, and support actually works." },
  { id: "p82", slug: "sweepstakes-no-deposit-bonus-explained",         title: "Sweepstakes No Deposit Bonus — Does Royalties Offer One?",                excerpt: "Royalties doesn't offer a true no-deposit bonus — here's what's actually free: the welcome bonus, daily rewards and referral coins.", cover_image_url: "https://images.pexels.com/photos/4841691/pexels-photo-4841691.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940", tags: ["sweepstakes no deposit bonus", "free sweepstakes coins"],       published_at: new Date(Date.now() - 10 * 10000).toISOString(), seo_title: "Sweepstakes No Deposit Bonus Explained | Royalties", seo_description: "Does Royalties have a no-deposit bonus? Here's the honest answer, plus what's genuinely free: welcome bonus, daily rewards and referrals." },
  { id: "p83", slug: "sweeps-coins-explained",                         title: "Sweeps Coins Explained — And How Royalties's System Actually Works",       excerpt: "What sweeps coins usually mean on other platforms, and how Royalties's wallet, game credits and coins/XP system actually works instead.", cover_image_url: "https://images.pexels.com/photos/3790639/pexels-photo-3790639.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940", tags: ["sweeps coins explained", "gold coins vs sweeps coins"],          published_at: new Date(Date.now() - 8 * 10000).toISOString(),  seo_title: "Sweeps Coins Explained | Royalties", seo_description: "What are sweeps coins? How the common gold-coins/sweeps-coins model works elsewhere, and how Royalties's wallet and rewards system differs." },
  { id: "p84", slug: "boss-fish-jackpot-timing-guide",                 title: "Boss Fish & Jackpot Timing Guide — Every Royalties Game Compared",        excerpt: "When to expect Boss encounters and jackpot windows across Fire Kirin, Juwa, Orion Stars, Mafia, Panda Master and Milky Way.", cover_image_url: "https://images.pexels.com/photos/1006060/pexels-photo-1006060.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940", tags: ["boss fish timing", "jackpot timing sweepstakes"],                 published_at: new Date(Date.now() - 6 * 10000).toISOString(),  seo_title: "Boss Fish & Jackpot Timing Guide | Royalties", seo_description: "Boss encounter and jackpot timing patterns across every major Royalties fish table game — Fire Kirin, Juwa, Orion Stars, Mafia and more." },
  { id: "p85", slug: "Royalties-vs-online-casinos",                    title: "Royalties vs Online Casinos — What's the Difference?",                    excerpt: "How Royalties's sweepstakes model differs from a licensed online casino, and what that means for where you can play.", cover_image_url: "https://images.pexels.com/photos/8817671/pexels-photo-8817671.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940", tags: ["sweepstakes vs online casino", "Royalties vs casino"],           published_at: new Date(Date.now() - 4 * 10000).toISOString(),  seo_title: "Royalties vs Online Casinos Explained", seo_description: "Royalties vs online casinos: how the sweepstakes model differs from licensed real-money gambling, and what it means for player access." },
];
  ...
  return withFallback(
    (async () => {
      ...
      const { data, error } = await supabase
        ...
        .limit(50);
      if (error || !data?.length) return null;
      return (data as MarketingPost[]).map(RoyaltiesBrandPost);
    })(),
    FALLBACK_BLOG_POSTS
  ).then((posts) => posts.map(RoyaltiesBrandPost));
}
...
export const getLatestBlogPosts = unstable_cache(
  async (): Promise<MarketingPost[]> => {
    return withFallback(
      ...
      FALLBACK_BLOG_POSTS.slice(0, 6).map(RoyaltiesBrandPost)
    ).then((posts) => posts.map(RoyaltiesBrandPost));
  },
  ["marketing-latest-blog-posts-Royalties-v2"],
  { revalidate: 300 }
);
...
export async function getBlogPost(slug: string): Promise<MarketingPostFull | null> {
  try {
    ...
    const { data } = await supabase
      ...
      .eq("is_published", true)
      .single();
    if (data?.content) return RoyaltiesBrandPostFull(data as MarketingPostFull);
    const fb = fallbackPost(slug);
    return fb ? RoyaltiesBrandPostFull(fb) : null;
  } catch {
    const fb = fallbackPost(slug);
    return fb ? RoyaltiesBrandPostFull(fb) : null;
  }
...
function fallbackPost(slug: string): MarketingPostFull | null {
  ...
  if (!card) return null;
  return RoyaltiesBrandPostFull({ ...card, content: card.excerpt });
}
