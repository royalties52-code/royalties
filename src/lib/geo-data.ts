...
export const GEO_STATES: Record<string, StateData> = {
  texas: {
    ...
    heroLede:
      "ROYALTIES is available to players across Texas — from Houston and Dallas to San Antonio and Austin. Play Fire Kirin, Juwa, Orion Stars, Game Vault and 8 more sweepstakes fish table games online. 50% welcome bonus on every title.",
    metaDescription:
    ...
    cities: [
      ...
      { name: "Austin", slug: "austin", descriptionSnippet: "Austin players can access all 12 ROYALTIES games" },
  ...
  florida: {
    ...
    heroLede:
      "ROYALTIES serves players across Florida — Miami, Orlando, Jacksonville, Tampa and beyond. Access all 12 fish table & sweepstakes games with a 50% welcome bonus. Instant accounts and wallet-funded credits.",
    metaDescription:
  ...
  georgia: {
    ...
    heroLede:
      "ROYALTIES is available to players across Georgia including Atlanta, Augusta, Savannah and Columbus. Play 12 premium sweepstakes fish table and slot games online. 50% welcome bonus, instant account setup.",
    metaDescription:
  ...
  california: {
    ...
    heroLede:
      "ROYALTIES serves players across California — Los Angeles, San Diego, Sacramento, Fresno and beyond. All 12 sweepstakes fish table games available online with a 50% first deposit welcome bonus.",
    metaDescription:
    ...
    cities: [
      ...
      { name: "Fresno", slug: "fresno", descriptionSnippet: "Fresno players access all 12 ROYALTIES sweepstakes games" },
    ],
  },
  "north-carolina": {
    name: "North Carolina",
    ...
    heroLede:
      "ROYALTIES is available to players across North Carolina including Charlotte, Raleigh and Greensboro. Play Fire Kirin, Juwa, Orion Stars and 9 more sweepstakes games online with a 50% welcome bonus.",
    metaDescription:
  ...
  ohio: {
    ...
    heroLede:
      "ROYALTIES serves players across Ohio — Columbus, Cleveland, Cincinnati and beyond. All 12 sweepstakes fish table and slot games available online. 50% welcome bonus and instant account setup.",
    metaDescription:
    ...
    cities: [
      ...
      { name: "Cincinnati", slug: "cincinnati", descriptionSnippet: "Cincinnati players access all 12 ROYALTIES games online" },
    ],
  },
  michigan: {
    name: "Michigan",
    ...
    heroLede:
      "ROYALTIES is available to players across Michigan — Detroit, Grand Rapids and beyond. Play all 12 sweepstakes fish table and slot games online. 50% welcome bonus applied automatically to every new account.",
    metaDescription:
