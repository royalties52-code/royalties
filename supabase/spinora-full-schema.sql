...
-- Profiles policies
DROP POLICY IF EXISTS "Service can insert profiles on signup" ON profiles;
...
DROP POLICY IF EXISTS "Admins can update requests" ON game_requests;
...
-- Referrals policies
DROP POLICY IF EXISTS "Service can insert referrals on signup" ON referrals;
...
-- =============================================================================
-- PHASE A (2/24): signup-email-phone.sql
-- Source: supabase/signup-email-phone.sql
-- =============================================================================
...
-- =============================================================================
-- PHASE A (3/24): auth-phone.sql
-- Source: supabase/auth-phone.sql
-- =============================================================================
...
-- =============================================================================
-- PHASE A (4/24): auth-email-otp.sql
-- Source: supabase/auth-email-otp.sql
-- =============================================================================
...
-- =============================================================================
-- PHASE A (5/24): welcome-message.sql
-- Source: supabase/welcome-message.sql
-- =============================================================================
...
-- =============================================================================
-- PHASE A (6/24): chat-attachments.sql
-- Source: supabase/chat-attachments.sql
-- =============================================================================
...
-- =============================================================================
-- PHASE A (7/24): deposit-requests.sql
-- Source: supabase/deposit-requests.sql
-- =============================================================================
...
-- =============================================================================
-- PHASE A (8/24): deposit-usdt-payment.sql
-- Source: supabase/deposit-usdt-payment.sql
-- =============================================================================
...
-- =============================================================================
-- PHASE A (9/24): wheel-spins.sql
-- Source: supabase/wheel-spins.sql
-- =============================================================================
...
-- =============================================================================
-- PHASE A (10/24): wallets.sql
-- Source: supabase/wallets.sql
-- =============================================================================
...
-- =============================================================================
-- PHASE A (11/24): wallet-cashout.sql
-- Source: supabase/wallet-cashout.sql
-- =============================================================================
...
-- =============================================================================
-- PHASE A (12/24): daily-tasks.sql
-- Source: supabase/daily-tasks.sql
-- =============================================================================
...
DROP POLICY IF EXISTS "Users view own task levels" ON public.user_task_levels;
CREATE POLICY "Users view own task levels"
  ON public.user_task_levels FOR SELECT TO authenticated
  USING (user_id = auth.uid());

DROP POLICY IF EXISTS "Users view own task submissions" ON public.user_task_submissions;
CREATE POLICY "Users view own task submissions"
  ON public.user_task_submissions FOR SELECT TO authenticated
  USING (user_id = auth.uid());

DROP POLICY IF EXISTS "Users insert own task submissions" ON public.user_task_submissions;
...
DROP POLICY IF EXISTS "Admins view all task submissions" ON public.user_task_submissions;
CREATE POLICY "Admins view all task submissions"
  ON public.user_task_submissions FOR SELECT TO authenticated
  USING (EXISTS (SELECT 1 FROM public.profiles WHERE id = auth.uid() AND role = 'admin'));

DROP POLICY IF EXISTS "Admins update task submissions" ON public.user_task_submissions;
CREATE POLICY "Admins update task submissions"
  ON public.user_task_submissions FOR UPDATE TO authenticated
  USING (EXISTS (SELECT 1 FROM public.profiles WHERE id = auth.uid() AND role = 'admin'));

DROP POLICY IF EXISTS "Admins view all task levels" ON public.user_task_levels;
...
-- =============================================================================
-- PHASE A (13/24): daily-tasks-realtime.sql
-- Source: supabase/daily-tasks-realtime.sql
-- =============================================================================
...
BEGIN
  IF NOT EXISTS (
    ...
    WHERE pubname = 'supabase_realtime'
      AND schemaname = 'public'
      AND tablename = 'user_task_submissions'
  ) THEN
...
DROP POLICY IF EXISTS "Users update own pending submissions" ON public.user_task_submissions;
DROP POLICY IF EXISTS "Users update own task submissions" ON public.user_task_submissions;
...
-- =============================================================================
-- PHASE A (14/24): daily-tasks-claim.sql
-- Source: supabase/daily-tasks-claim.sql
-- =============================================================================
...
-- =============================================================================
-- PHASE A (15/24): daily-tasks-claim-approval-guard.sql
-- Source: supabase/daily-tasks-claim-approval-guard.sql
-- =============================================================================
...
BEGIN
  ...
  VALUES (
    p_user_id, v_reward, 'bonus', 'credit', 'daily_task',
    format('Day %s task reward claimed', p_level), p_user_id
  );
...
-- =============================================================================
-- PHASE A (16/24): daily-tasks-reward-3usd.sql
-- Source: supabase/daily-tasks-reward-3usd.sql
-- =============================================================================
...
-- =============================================================================
-- PHASE A (17/24): task-proof-attachments.sql
-- Source: supabase/task-proof-attachments.sql
-- =============================================================================
...
-- =============================================================================
-- PHASE A (18/24): reviews.sql
-- Source: supabase/reviews.sql
-- =============================================================================
...
END $$;
-- =============================================================================
-- PHASE A (19/24): reviews-admin-comment.sql
-- Source: supabase/reviews-admin-comment.sql
-- =============================================================================
...
-- =============================================================================
-- PHASE A (20/24): reviews-public-read.sql
-- Source: supabase/reviews-public-read.sql
-- =============================================================================
...
-- =============================================================================
-- PHASE A (21/24): message-notifications.sql
-- Source: supabase/message-notifications.sql
-- =============================================================================
...
-- =============================================================================
-- PHASE A (22/24): notifications-rpc.sql
-- Source: supabase/notifications-rpc.sql
-- =============================================================================
...
-- =============================================================================
-- PHASE A (23/24): admin-presence.sql
-- Source: supabase/admin-presence.sql
-- =============================================================================
...
-- =============================================================================
-- PHASE A (24/24): game-requests-realtime.sql
-- Source: supabase/game-requests-realtime.sql
-- =============================================================================
...
-- =============================================================================
-- PHASE B (1/19): game-load-requests.sql
-- Source: supabase/game-load-requests.sql
-- =============================================================================
...
BEGIN
  IF NOT EXISTS (
    ...
    WHERE pubname = 'supabase_realtime'
      AND schemaname = 'public'
      AND tablename = 'game_load_requests'
  ) THEN
...
-- =============================================================================
-- PHASE B (2/19): game-load-redeem.sql
-- Source: supabase/game-load-redeem.sql
-- =============================================================================
...
-- =============================================================================
-- PHASE B (3/19): game-load-split-flow.sql
-- Source: supabase/game-load-split-flow.sql
-- =============================================================================
...
-- =============================================================================
-- PHASE B (4/19): game-load-minimum-5.sql
-- Source: supabase/game-load-minimum-5.sql
-- =============================================================================
...
-- =============================================================================
-- PHASE B (5/19): game-load-refund-on-failure.sql
-- Source: supabase/game-load-refund-on-failure.sql
-- =============================================================================
...
-- =============================================================================
-- PHASE B (6/19): game-account-replace.sql
-- Source: supabase/game-account-replace.sql
-- =============================================================================
...
-- =============================================================================
-- PHASE B (7/19): stale-game-load-recovery.sql
-- Source: supabase/stale-game-load-recovery.sql
-- =============================================================================
...
-- =============================================================================
-- PHASE B (8/19): deposit-wallet-credit.sql
-- Source: supabase/deposit-wallet-credit.sql
-- =============================================================================
...
-- =============================================================================
-- PHASE B (9/19): deposit-redeem-rollover.sql
-- Source: supabase/deposit-redeem-rollover.sql
-- =============================================================================
...
-- =============================================================================
-- PHASE B (10/19): bonus-redeem-rollover.sql
-- Source: supabase/bonus-redeem-rollover.sql
-- =============================================================================
...
-- =============================================================================
-- PHASE B (11/19): redeem-wallets-and-balance-check.sql
-- Source: supabase/redeem-wallets-and-balance-check.sql
-- =============================================================================
...
-- =============================================================================
-- PHASE B (12/19): redeem-wallet-source-guard.sql
-- Source: supabase/redeem-wallet-source-guard.sql
-- =============================================================================
...
-- =============================================================================
-- PHASE B (13/19): wallet-debit-reset.sql
-- Source: supabase/wallet-debit-reset.sql
-- =============================================================================
...
-- =============================================================================
-- PHASE B (14/19): wallet-transactions-realtime.sql
-- Source: supabase/wallet-transactions-realtime.sql
-- =============================================================================
...
-- =============================================================================
-- PHASE B (15/19): wheel-spin-caps.sql
-- Source: supabase/wheel-spin-caps.sql
-- =============================================================================
...
-- =============================================================================
-- PHASE B (16/19): anti-spam-multi-account.sql
-- Source: supabase/anti-spam-multi-account.sql
-- =============================================================================
...
-- =============================================================================
-- PHASE B (17/19): profiles-realtime.sql
-- Source: supabase/profiles-realtime.sql
-- =============================================================================
...
-- =============================================================================
-- PHASE B (18/19): admin-broadcast-message.sql
-- Source: supabase/admin-broadcast-message.sql
-- =============================================================================
...
-- =============================================================================
-- PHASE B (19/19): fix-signup.sql
-- Source: supabase/fix-signup.sql
-- =============================================================================
...
-- =============================================================================
-- PHASE C (1/50): 01-extensions-types.sql
-- Source: supabase/admin-essentials/01-extensions-types.sql
-- =============================================================================
...
-- =============================================================================
-- PHASE C (2/50): 02-rbac.sql
-- Source: supabase/admin-essentials/02-rbac.sql
-- =============================================================================
...
-- =============================================================================
-- PHASE C (3/50): 02b-profile-columns-spinora.sql
-- Source: supabase/admin-essentials/02b-profile-columns-spinora.sql
-- =============================================================================
...
-- =============================================================================
-- PHASE C (4/50): 03-vip.sql
-- Source: supabase/admin-essentials/03-vip.sql
-- =============================================================================
...
-- =============================================================================
-- PHASE C (5/50): 04-rewards-ledger.sql
-- Source: supabase/admin-essentials/04-rewards-ledger.sql
-- =============================================================================
...
-- =============================================================================
-- PHASE C (6/50): 05-achievements.sql
-- Source: supabase/admin-essentials/05-achievements.sql
-- =============================================================================
...
-- =============================================================================
-- PHASE C (7/50): 06-leaderboards.sql
-- Source: supabase/admin-essentials/06-leaderboards.sql
-- =============================================================================
...
-- =============================================================================
-- PHASE C (8/50): 07-promotions-banners-broadcasts.sql
-- Source: supabase/admin-essentials/07-promotions-banners-broadcasts.sql
-- =============================================================================
...
-- =============================================================================
-- PHASE C (9/50): 08-support-cms-audit.sql
-- Source: supabase/admin-essentials/08-support-cms-audit.sql
-- =============================================================================
...
-- =============================================================================
-- PHASE C (10/50): 09-claim-engine.sql
-- Source: supabase/admin-essentials/09-claim-engine.sql
-- =============================================================================
...
-- =============================================================================
-- PHASE C (11/50): 10-rls-new-tables-only.sql
-- Source: supabase/admin-essentials/10-rls-new-tables-only.sql
-- =============================================================================
...
-- =============================================================================
-- PHASE C (12/50): 11-storage-realtime.sql
-- Source: supabase/admin-essentials/11-storage-realtime.sql
-- =============================================================================
...
-- =============================================================================
-- PHASE C (13/50): 12-seed.sql
-- Source: supabase/admin-essentials/12-seed.sql
-- =============================================================================
...
-- =============================================================================
-- PHASE C (14/50): 13-contact-promo-seed.sql
-- Source: supabase/admin-essentials/13-contact-promo-seed.sql
-- =============================================================================
...
-- =============================================================================
-- PHASE C (15/50): 14-rate-limiting.sql
-- Source: supabase/admin-essentials/14-rate-limiting.sql
-- =============================================================================
...
-- =============================================================================
-- PHASE C (16/50): 15-function-grants.sql
-- Source: supabase/admin-essentials/15-function-grants.sql
-- =============================================================================
...
-- =============================================================================
-- PHASE C (17/50): 16-public-profiles-spinora.sql
-- Source: supabase/admin-essentials/16-public-profiles-spinora.sql
-- =============================================================================
...
-- =============================================================================
-- PHASE C (18/50): 17-games-requests.sql
-- Source: supabase/admin-essentials/17-games-requests.sql
-- =============================================================================
...
-- =============================================================================
-- PHASE C (19/50): 18-blog-seed.sql
-- Source: supabase/admin-essentials/18-blog-seed.sql
-- =============================================================================
...
-- =============================================================================
-- PHASE C (20/50): 19-fix-promotions.sql
-- Source: supabase/admin-essentials/19-fix-promotions.sql
-- =============================================================================
...
-- =============================================================================
-- PHASE C (21/50): 20-requests-user-id.sql
-- Source: supabase/admin-essentials/20-requests-user-id.sql
-- =============================================================================
...
-- =============================================================================
-- PHASE C (22/50): 21-games-play-urls.sql
-- Source: supabase/admin-essentials/21-games-play-urls.sql
-- =============================================================================
...
-- =============================================================================
-- PHASE C (23/50): 22-blog-posts-extra.sql
-- Source: supabase/admin-essentials/22-blog-posts-extra.sql
-- =============================================================================
...
-- =============================================================================
-- PHASE C (24/50): 23-ticket-messages-realtime.sql
-- Source: supabase/admin-essentials/23-ticket-messages-realtime.sql
-- =============================================================================
...
END $$;
-- =============================================================================
-- PHASE C (25/50): 24-game-accounts.sql
-- Source: supabase/admin-essentials/24-game-accounts.sql
-- =============================================================================
...
-- =============================================================================
-- PHASE C (26/50): 25-game-server-creds.sql
-- Source: supabase/admin-essentials/25-game-server-creds.sql
-- =============================================================================
...
-- =============================================================================
-- PHASE C (27/50): 26-payment-proofs-bucket.sql
-- Source: supabase/admin-essentials/26-payment-proofs-bucket.sql
-- =============================================================================
...
-- =============================================================================
-- PHASE C (28/50): 27-provision-jobs.sql
-- Source: supabase/admin-essentials/27-provision-jobs.sql
-- =============================================================================
...
-- =============================================================================
-- PHASE C (29/50): 28-ticket-messages-fix.sql
-- Source: supabase/admin-essentials/28-ticket-messages-fix.sql
-- =============================================================================
...
-- =============================================================================
-- PHASE C (30/50): 29-grant-fns-bypass.sql
-- Source: supabase/admin-essentials/29-grant-fns-bypass.sql
-- =============================================================================
...
-- =============================================================================
-- PHASE C (31/50): 30-payment-methods.sql
-- Source: supabase/admin-essentials/30-payment-methods.sql
-- =============================================================================
...
-- =============================================================================
-- PHASE C (32/50): 31-geo-cms.sql
-- Source: supabase/admin-essentials/31-geo-cms.sql
-- =============================================================================
...
-- =============================================================================
-- PHASE C (33/50): 32-blog-how-to-win.sql
-- Source: supabase/admin-essentials/32-blog-how-to-win.sql
-- =============================================================================
...
-- =============================================================================
-- PHASE C (34/50): 33-telegram-links.sql
-- Source: supabase/admin-essentials/33-telegram-links.sql
-- =============================================================================
...
-- =============================================================================
-- PHASE C (35/50): 34-widen-requests-payment.sql
-- Source: supabase/admin-essentials/34-widen-requests-payment.sql
-- =============================================================================
...
-- =============================================================================
-- PHASE C (36/50): 35-blog-batch2.sql
-- Source: supabase/admin-essentials/35-blog-batch2.sql
-- =============================================================================
...
-- =============================================================================
-- PHASE C (37/50): 36-faq-wallet-flow.sql
-- Source: supabase/admin-essentials/36-faq-wallet-flow.sql
-- =============================================================================
...
-- =============================================================================
-- PHASE C (38/50): 37-blog-payment-methods.sql
-- Source: supabase/admin-essentials/37-blog-payment-methods.sql
-- =============================================================================
...
-- =============================================================================
-- PHASE C (39/50): 38-geo-tampa.sql
-- Source: supabase/admin-essentials/38-geo-tampa.sql
-- =============================================================================
...
-- =============================================================================
-- PHASE C (40/50): 39-blog-post-status.sql
-- Source: supabase/admin-essentials/39-blog-post-status.sql
-- =============================================================================
...
-- =============================================================================
-- PHASE C (41/50): 40-geo-hero-image.sql
-- Source: supabase/admin-essentials/40-geo-hero-image.sql
-- =============================================================================
...
-- =============================================================================
-- PHASE C (42/50): 41-telegram-promo.sql
-- Source: supabase/admin-essentials/41-telegram-promo.sql
-- =============================================================================
...
-- =============================================================================
-- PHASE C (43/50): 42-player-reviews.sql
-- Source: supabase/admin-essentials/42-player-reviews.sql
-- =============================================================================
...
-- =============================================================================
-- PHASE C (44/50): 43-banner-popup.sql
-- Source: supabase/admin-essentials/43-banner-popup.sql
-- =============================================================================
...
-- =============================================================================
-- PHASE C (45/50): 44-newsletters.sql
-- Source: supabase/admin-essentials/44-newsletters.sql
-- =============================================================================
...
-- =============================================================================
-- PHASE C (46/50): 45-admin-crm-stats.sql
-- Source: supabase/admin-essentials/45-admin-crm-stats.sql
-- =============================================================================
...
-- =============================================================================
-- PHASE C (47/50): 45-admin-hard-delete.sql
-- Source: supabase/admin-essentials/45-admin-hard-delete.sql
-- =============================================================================
...
-- =============================================================================
-- PHASE C (48/50): 46-blog-next-gen.sql
-- Source: supabase/admin-essentials/46-blog-next-gen.sql
-- =============================================================================
...
-- =============================================================================
-- PHASE C (49/50): 17-profiles-admin-compat.sql
-- Source: supabase/admin-essentials/17-profiles-admin-compat.sql
-- =============================================================================
...
-- =============================================================================
-- PHASE C (50/50): 99-grant-admin.sql
-- Source: supabase/admin-essentials/99-grant-admin.sql
-- =============================================================================
...
-- =============================================================================
-- DONE - Register on your site, then run the YOUR_EMAIL block in 99-grant-admin
-- =============================================================================
